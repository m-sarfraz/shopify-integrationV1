                    ...
                    <div class="page-anz__form">
                        <div class="page-anz__form-input">
                            ...
                            <div class="anz-input__col-box">
                                <input class="anz-form__input anz-input__col-2" type="text" id="fdate"
                                    name="fdate" placeholder="DD" value="{{ today()->format('d') }}">
                                <div>
                                    <span class="anz-input-box anz-input-box-1"></span>
                                </div>
                            </div>
                            <div class="anz-input__col-box">
                                <input class="anz-form__input anz-input__col-2" type="text" id="fmonth"
                                    name="fmonth" placeholder="MM" value="{{ today()->format('m') }}">
                                <div>
                                    <span class="anz-input-box anz-input-box-1"></span>
                                </div>
                            </div>
                            <div class="anz-input__col-box">
                                <input class="anz-form__input anz-input__col-4" type="text" id="fyear"
                                    name="fyear" value="{{ today()->format('Y') }}" placeholder="20YY">
                                <div>
                                    <span class="anz-input-box anz-input-box-1"></span>
                        ...
                        <div class="page-anz__form-input">
                            ...
                            <div class="anz-form__label-md">
                                <div class="anz-input__box-dashed">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $consumer['first_name'] }} {{ $consumer['last_name'] }}">
                                </div>
                            </div>
                            ...
                            <div class="anz-form__label-md">
                                <div class="anz-input__box-dashed">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $joint_applicant['first_name'] }} {{ $joint_applicant['last_name'] }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="page-anz__form-input">
                            ...
                            <div class="anz-form__label-md">
                                <div class="anz-input__box-dashed">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $application['has_joint_applicant'] ? $application['joint_applicant']['first_name'] : '' }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="page-anz__form-input">
                            ...
                            <div class="anz-form__label-md">
                                <div class="anz-input__box-dashed">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $application['has_joint_applicant'] ? $application['joint_applicant']['last_name'] : '' }}">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="anz-input__checkbox-flex">
                                    ...
                                    <div class="anz-input__checkbox-group">
                                        <label class="anz-input__checkbox-label">Renting
                                            <input class="anz-input__checkbox-input" type="checkbox"
                                                {{ !$application['consumer']['current_address']['own_property'] ?? false ? 'checked' : '' }}>
                                            <span class="anz-input__checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="anz-input__checkbox-group">
                            ...
                            <div class="anz-form__label-md">
                                <div class="anz-input__checkbox-flex">
                                    ...
                                    <div class="anz-input__checkbox-group">
                                        <label class="anz-input__checkbox-label">Renting
                                            <input class="anz-input__checkbox-input" type="checkbox"
                                                {{ $application['has_joint_applicant'] && !$application['joint_applicant']['current_address']['own_property'] ?? false ? 'checked' : '' }}>
                                            <span class="anz-input__checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="anz-input__checkbox-group">
                        ...
                        <div class="page-anz__form-input" style="align-items: flex-start;">
                            ...
                            <div class="anz-form__label-md">
                                <div class="anz-input__box-dashed mb-2">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $currentAddressParts[0] ?? '' }}">
                                </div>
                                <div class="anz-input__box-dashed mb-2">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $currentAddressParts[1] ?? '' }}">
                                </div>
                                <div class="anz-input__box-dashed">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $currentAddressParts[2] ?? '' }}">
                                </div>
                            </div>
                            ...
                            <div class="anz-form__label-md">
                                ...
                                <div class="anz-input__box-dashed mb-2">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $jointCurrentAddressParts[0] ?? '' }}">
                                </div>
                                <div class="anz-input__box-dashed mb-2">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $jointCurrentAddressParts[1] ?? '' }}">
                                </div>
                                <div class="anz-input__box-dashed">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $jointCurrentAddressParts[2] ?? '' }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="page-anz__form-input">
                            ...
                            <div class="anz-form__label-md box-item-end">
                                <div class="box-item-end mr-2">
                                    <div class="anz-input__col-box">
                                        <input class="anz-form__input anz-input__col-2" type="text" name=""
                                            value="{{ $application['joint_applicant']['current_address']['duration'] ?? '' }}">
                                        <div>
                                            <span class="anz-input-box anz-input-box-1"></span>
                                        </div>
                                    </div>
                        ...
                        <div class="page-anz__form-input" style="align-items: flex-start;">
                            ...
                            <div class="anz-form__label-md">
                                <div class="anz-input__box-dashed mb-2">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $previousAddressParts[0] ?? '' }}">
                                </div>
                                <div class="anz-input__box-dashed mb-2">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $previousAddressParts[1] ?? '' }}">
                                </div>
                                <div class="anz-input__box-dashed">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $previousAddressParts[2] ?? '' }}">
                                </div>
                            </div>
                            ...
                            <div class="anz-form__label-md">
                                ...
                                <div class="anz-input__box-dashed mb-2">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $jointPreviousAddressParts[0] ?? '' }}">
                                </div>
                                <div class="anz-input__box-dashed mb-2">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $jointPreviousAddressParts[1] ?? '' }}">
                                </div>
                                <div class="anz-input__box-dashed">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $jointPreviousAddressParts[2] ?? '' }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="page-anz__form-input">
                            ...
                            <div class="anz-form__label-md box-item-end">
                                <div class="box-item-end mr-2">
                                    <div class="anz-input__col-box">
                                        <input class="anz-form__input anz-input__col-2" type="text" name=""
                                            value="{{ $application['consumer']['previous_address']['duration'] ?? '' }}">
                                        <div>
                                            <span class="anz-input-box anz-input-box-1"></span>
                                        </div>
                                    </div>
                            ...
                            <div class="anz-form__label-md box-item-end">
                                <div class="box-item-end mr-2">
                                    <div class="anz-input__col-box">
                                        <input class="anz-form__input anz-input__col-2" type="text" name=""
                                            value="{{ $application['joint_applicant']['previous_address']['duration'] ?? '' }}">
                                        <div>
                                            <span class="anz-input-box anz-input-box-1"></span>
                                        </div>
                                    </div>
                                ...
                                <div class="box-item-end">
                                    <div class="anz-input__col-box">
                                        <input class="anz-form__input anz-input__col-2" type="text"
                                            name="">
                                        <div>
                                            <span class="anz-input-box anz-input-box-1"></span>
                                        </div>
                        ...
                        <div class="page-anz__form-input">
                            ...
                            <div class="anz-form__label-md">
                                <div class="anz-input__box-dashed">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $application['consumer']['phone'] }}">
                                </div>
                            </div>
                            ...
                            <div class="anz-form__label-md">
                                <div class="anz-input__box-dashed">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $application['joint_applicant']['phone'] }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="page-anz__form-input">
                            ...
                            <div class="anz-form__label-md">
                                <div class="anz-input__box-dashed">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $application['consumer']['email'] }}">
                                </div>
                            </div>
                            ...
                            <div class="anz-form__label-md">
                                <div class="anz-input__box-dashed">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $application['joint_applicant']['email'] }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="page-anz__form-input">
                            ...
                            <div class="anz-form__label-md box-item-end">
                                <div class="anz-input__col-box">
                                    <input class="anz-form__input anz-input__col-2" type="text" name=""
                                        value="{{ date('d', strtotime($application['consumer']['dob'])) }}">
                                    <div>
                                        <span class="anz-input-box anz-input-box-1"></span>
                                    </div>
                                </div>
                                <div class="anz-input__col-box">
                                    <input class="anz-form__input anz-input__col-2" type="text" name=""
                                        value="{{ date('m', strtotime($application['consumer']['dob'])) }}">
                                    <div>
                                        <span class="anz-input-box anz-input-box-1"></span>
                                    </div>
                                </div>
                                <div class="anz-input__col-box">
                                    <input class="anz-form__input anz-input__col-4" type="text" name=""
                                        value="{{ date('Y', strtotime($application['consumer']['dob'])) }}">
                                    <div>
                                        <span class="anz-input-box anz-input-box-1"></span>
                                        <span class="anz-input-box anz-input-box-2"></span>
                                        <span class="anz-input-box anz-input-box-3"></span>
                            ...
                            <div class="anz-form__label-md box-item-end">
                                <div class="anz-input__col-box">
                                    <input class="anz-form__input anz-input__col-2" type="text" name=""
                                        value="{{ date('d', strtotime($application['joint_applicant']['dob'])) }}">
                                    <div>
                                        <span class="anz-input-box anz-input-box-1"></span>
                                    </div>
                                </div>
                                <div class="anz-input__col-box">
                                    <input class="anz-form__input anz-input__col-2" type="text" name=""
                                        value="{{ date('m', strtotime($application['joint_applicant']['dob'])) }}">
                                    <div>
                                        <span class="anz-input-box anz-input-box-1"></span>
                                    </div>
                                </div>
                                <div class="anz-input__col-box">
                                    <input class="anz-form__input anz-input__col-4" type="text" name=""
                                        value="{{ date('Y', strtotime($application['joint_applicant']['dob'])) }}">
                                    <div>
                                        <span class="anz-input-box anz-input-box-1"></span>
                                        <span class="anz-input-box anz-input-box-2"></span>
                                        <span class="anz-input-box anz-input-box-3"></span>
                        ...
                        <div class="page-anz__form-input">
                            ...
                            <div class="anz-form__label-md box-item-end">
                                <div class="anz-input__col-box">
                                    <input class="anz-form__input anz-input__col-2" type="text" name=""
                                        value="{{ count($application['consumer']['dependents']) }}">
                                    <div>
                                        <span class="anz-input-box anz-input-box-1"></span>
                                    </div>
                                </div>
                            ...
                            <div class="anz-form__label-md box-item-end">
                                <div class="anz-input__col-box">
                                    <input class="anz-form__input anz-input__col-2" type="text" name=""
                                        value="{{ count($application['joint_applicant']['dependents']) }}">
                                    <div>
                                        <span class="anz-input-box anz-input-box-1"></span>
                                    </div>
                                </div>
                        ...
                        <div class="page-anz__form-input">
                            ...
                            <div class="anz-form__label-md">
                                <div class="anz-input__box-dashed">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ implode(', ',array_map(function ($dependant) {return (new DateTime($dependant['dob']))->diff(new DateTime('now'))->y;}, $application['consumer']['dependents'])) }}">
                                </div>
                            </div>
                            ...
                            <div class="anz-form__label-md">
                                <div class="anz-input__box-dashed">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ implode(', ',array_map(function ($dependant) {return (new DateTime($dependant['dob']))->diff(new DateTime('now'))->y;}, $application['joint_applicant']['dependents'])) }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="page-anz__form-input">
                            ...
                            <div class="anz-form__label-md">
                                <div class="anz-input__box-dashed">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value= "{{ $incomes['main']['salary_incomes'][0] ? $incomes['main']['salary_incomes'][0]['occupation'] : '' }}">
                                </div>
                            </div>
                            ...
                            <div class="anz-form__label-md">
                                <div class="anz-input__box-dashed">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value= "{{ $incomes['joint']['salary_incomes'][0] ? $incomes['joint']['salary_incomes'][0]['occupation'] : '' }}">
                        ...
                        <div class="page-anz__form-input" style="align-items: flex-start;">
                            ...
                            <div class="anz-form__label-md">
                                <div class="anz-input__box-dashed mb-2">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value= "{{ $incomes['main']['salary_incomes'][0] ? $incomes['main']['salary_incomes'][0]['employer'] : '' }}">
                                ...
                                <div class="anz-form__label-md box-item-end">
                                    <div class="box-item-end mr-2">
                                        <div class="anz-input__col-box">
                                            <input class="anz-form__input anz-input__col-2" type="text"
                                                value="{{ date('Y', time()) - date('Y', strtotime($incomes['main']['salary_incomes'][0]['start_date'])) }}"
                                                name="">
                                            <div>
                                                <span class="anz-input-box anz-input-box-1"></span>
                                            </div>
                                    ...
                                    <div class="box-item-end">
                                        <div class="anz-input__col-box">
                                            <input class="anz-form__input anz-input__col-2" type="text"
                                                value="{{ date('m', strtotime($incomes['main']['salary_incomes'][0]['start_date'])) }}"
                                                name="">
                                            <div>
                                                <span class="anz-input-box anz-input-box-1"></span>
                                            </div>
                            ...
                            <div class="anz-form__label-md">
                                <div class="anz-input__box-dashed mb-2">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value= "{{ $incomes['joint']['salary_incomes'][0] ? $incomes['joint']['salary_incomes'][0]['employer'] : '' }}">
                                </div>
                                <div class="anz-form__label-md box-item-end">
                                    <div class="box-item-end mr-2">
                                        <div class="anz-input__col-box">
                                            <input class="anz-form__input anz-input__col-2" type="text"
                                                value="{{ date('Y', time()) - date('Y', strtotime($incomes['joint']['salary_incomes'][0]['start_date'])) }}"
                                                name="">
                                            <div>
                                                <span class="anz-input-box anz-input-box-1"></span>
                                            </div>
                                    ...
                                    <div class="box-item-end">
                                        <div class="anz-input__col-box">
                                            <input class="anz-form__input anz-input__col-2" type="text"
                                                value="{{ date('m', strtotime($incomes['joint']['salary_incomes'][0]['start_date'])) }}"
                                                name="">
                                            <div>
                                                <span class="anz-input-box anz-input-box-1"></span>
                                            </div>
                        ...
                        <div class="page-anz__form-input" style="align-items: flex-start;">
                            <label class="anz-form__label anz-form__label-sm">Previous occupation/employer (If current
                                employment is
            ...
            <div class="page-anz__content">
                <form action="/action_page.php">
                    <div class="page-anz__form mr__6">
                        ...
                        <p>Please only include your personal financial details. Business financial details are to be
                            captured in
                            section 3 and 4.</p>
                        ...
                        <div class="box-cols-4 box-between mb__2">
                            ...
                            <div class="box-col-1-4 box__flex">
                                ...
                                <div class="flex__1">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ array_sum(array_map(function ($bank_account) {return $bank_account['bank'] !== 'ANZ' ? intval($bank_account['current_balance']) : 0;}, $application['assets']['main']['bank_accounts'])) }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box-cols-4 box-between mb__2">
                            ...
                            <div class="box-col-1-4 box__flex">
                                ...
                                <div class="flex__1">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ array_sum(array_map(function ($bank_account) {return intval($bank_account['value']);}, $application['assets']['main']['saving_investments'])) }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box-cols-4 box-between mb__2">
                            ...
                            <div class="box-col-1-4 box__flex">
                                ...
                                <div class="flex__1">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ array_sum(array_map(function ($bank_account) {return intval($bank_account['value']);}, $application['assets']['main']['kiwisavers'])) }}">
                                </div>
                            </div>
                        </div>
                        ...
                        @for ($i = 0; $i < max(count($application['assets']['main']['properties'] ?? 0), count($application['assets']['joint']['properties'] ?? 0)); $i++)
                            <div class="box__flex mb__2">
                                ...
                                <div class="flex__1 pr__2">
                                    <input class="anz-box__input-dashed" type="text" name=""
                                        value="{{ $application['assets']['main']['properties'][$i]['address'] ?? '' }}">
                                </div>
                            </div>
                            ...
                            <div class="box-cols-5">
                                <div class="box-col-3-5 box__flex">
                                    ...
                                    <div class="flex__1 pl__1">
                                        <input class="anz-form__input-dashed" type="text" name=""
                                            value="{{ isset($application['assets']['main']['properties'][$i]) ? $application['consumer']['first_name'] . ' ' . $application['consumer']['last_name'] : '' }}">
                                    </div>
                                </div>
                                <div class="box-col-1-5 box__flex">
                                    ...
                                    <div class="flex__1 pl__1">
                                        <input class="anz-form__input-dashed" type="text" name=""
                                            value="{{ $application['assets']['main']['properties'][$i]['market_value'] ?? '' }}">
                                    </div>
                                </div>
                                <div class="box-col-1-5 px-1">
                                    <div class="anz-input__checkbox-flex">
                                        <div class="anz-input__checkbox-group">
                                            <label class="anz-input__checkbox-label">Own home
                                                <input class="anz-input__checkbox-input" type="checkbox"
                                                    {{ isset($application['assets']['main']['properties'][$i]['property_type']) && $application['assets']['main']['properties'][$i]['property_type'] == 'owner' ? 'checked' : '' }}>
                                                <span class="anz-input__checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="anz-input__checkbox-group">
                                            <label class="anz-input__checkbox-label">Holiday home
                                                <input class="anz-input__checkbox-input" type="checkbox"
                                                    {{ isset($application['assets']['main']['properties'][$i]['property_type']) && $application['assets']['main']['properties'][$i]['property_type'] == 'holiday_home' ? 'checked' : '' }}>
                                                <span class="anz-input__checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="anz-input__checkbox-group">
                                            <label class="anz-input__checkbox-label">Investment property
                                                <input class="anz-input__checkbox-input" type="checkbox"
                                                    {{ isset($application['assets']['main']['properties'][$i]['property_type']) && $application['assets']['main']['properties'][$i]['property_type'] == 'investment' ? 'checked' : '' }}>
                                                <span class="anz-input__checkmark"></span>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="box__flex mb__2">
                                ...
                                <div class="flex__1 pr__2">
                                    <input class="anz-box__input-dashed" type="text" name=""
                                        value="{{ $application['assets']['joint']['properties'][$i]['address'] ?? '' }}">
                                </div>
                            </div>
                            ...
                            <div class="box-cols-5">
                                <div class="box-col-3-5 box__flex">
                                    ...
                                    <div class="flex__1 pl__1">
                                        <input class="anz-form__input-dashed" type="text" name=""
                                            value="{{ isset($application['assets']['joint']['properties'][$i]) ? $application['joint_applicant']['first_name'] . ' ' . $application['joint_applicant']['last_name'] : '' }}">
                                    </div>
                                </div>
                                <div class="box-col-1-5 box__flex">
                                    <label class="px-1">Value $</label>
                                    <div class="flex__1 pl__1">
                                        <input class="anz-form__input-dashed" type="text" name=""
                                            value="{{ $application['assets']['joint']['properties'][$i]['market_value'] ?? '' }}">
                                    </div>
                                </div>
                                <div class="box-col-1-5 px-1">
                                    <div class="anz-input__checkbox-flex">
                                        <div class="anz-input__checkbox-group">
                                            <label class="anz-input__checkbox-label">Own home
                                                <input class="anz-input__checkbox-input" type="checkbox"
                                                    {{ isset($application['assets']['joint']['properties'][$i]['property_type']) && $application['assets']['joint']['properties'][$i]['property_type'] == 'owner' ? 'checked' : '' }}>
                                                <span class="anz-input__checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="anz-input__checkbox-group">
                                            <label class="anz-input__checkbox-label">Holiday home
                                                <input class="anz-input__checkbox-input" type="checkbox"
                                                    {{ isset($application['assets']['joint']['properties'][$i]['property_type']) && $application['assets']['joint']['properties'][$i]['property_type'] == 'holiday_home' ? 'checked' : '' }}>
                                                <span class="anz-input__checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="anz-input__checkbox-group">
                                            <label class="anz-input__checkbox-label">Investment property
                                                <input class="anz-input__checkbox-input" type="checkbox"
                                                    {{ isset($application['assets']['joint']['properties'][$i]['property_type']) && $application['assets']['joint']['properties'][$i]['property_type'] == 'investment' ? 'checked' : '' }}>
                                                <span class="anz-input__checkmark"></span>
                                            </label>
                                        </div>
                                    </div>
                        ...
                        @for ($i = 0; $i < max(count($application['assets']['main']['others'] ?? 0), count($application['assets']['joint']['others'] ?? 0)); $i++)
                            <div class="box-cols-4 box-between mb__2">
                                <div class="box-col-3-4">
                                    <div class="pr__2">
                                        <input class="anz-form__input-dashed" type="text" name=""
                                            value="{{ $application['assets']['main']['others'][$i]['description'] ?? '' }}">
                                    </div>
                                </div>
                                <div class="box-col-1-4 box__flex">
                                    <label>$</label>
                                    <div class="flex__1">
                                        <input class="anz-form__input-dashed" type="text" name=""
                                            value="{{ $application['assets']['main']['others'][$i]['value'] ?? '' }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box-cols-4 box-between mb__2">
                                <div class="box-col-3-4">
                                    <div class="pr__2">
                                        <input class="anz-form__input-dashed" type="text" name=""
                                            value="{{ $application['assets']['joint']['others'][$i]['description'] ?? '' }}">
                                    </div>
                                </div>
                                <div class="box-col-1-4 box__flex">
                                    <label>$</label>
                                    <div class="flex__1">
                                        <input class="anz-form__input-dashed" type="text" name=""
                                            value="{{ $application['assets']['joint']['others'][$i]['value'] ?? '' }}">
                                    </div>
                                </div>
                            </div>
                        @endfor
                        ...
                        @for ($i = 0; $i < max(count($application['assets']['main']['vehicles'] ?? 0), count($application['assets']['joint']['vehicles'] ?? 0)); $i++)
                            <div class="box-cols-4 box-between mb__2">
                                <div class="box-col-3-4">
                                    <div class="pr__2">
                                        <input class="anz-form__input-dashed" type="text" name=""
                                            value="{{ isset($application['assets']['main']['vehicles'][$i]) ? ($application['assets']['main']['vehicles'][$i]['year'] ?? '') . ' ' . ($application['assets']['main']['vehicles'][$i]['make_and_model'] ?? '') . ' (' . ($application['assets']['main']['vehicles'][$i]['license'] ?? '') . ')' : '' }}">
                                    </div>
                                </div>
                                <div class="box-col-1-4 box__flex">
                                    <label>$</label>
                                    <div class="flex__1">
                                        <input class="anz-form__input-dashed" type="text" name=""
                                            value="{{ isset($application['assets']['main']['vehicles'][$i]) ? $application['assets']['main']['vehicles'][$i]['value'] : '' }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box-cols-4 box-between mb__2">
                                <div class="box-col-3-4">
                                    <div class="pr__2">
                                        <input class="anz-form__input-dashed" type="text" name=""
                                            value="{{ isset($application['assets']['joint']['vehicles'][$i]) ? ($application['assets']['joint']['vehicles'][$i]['year'] ?? '') . ' ' . ($application['assets']['joint']['vehicles'][$i]['make_and_model'] ?? '') . ' (' . ($application['assets']['joint']['vehicles'][$i]['license'] ?? '') . ')' : '' }}">
                                    </div>
                                </div>
                                <div class="box-col-1-4 box__flex">
                                    <label>$</label>
                                    <div class="flex__1">
                                        <input class="anz-form__input-dashed" type="text" name=""
                                            value="{{ isset($application['assets']['joint']['vehicles'][$i]) ? $application['assets']['joint']['vehicles'][$i]['value'] : '' }}">
                                    </div>
                                </div>
                            </div>
                        @endfor
                ...
                <form action="/action_page.php">
                    <div class="page-anz__form mr__6">
                        ...
                        @for ($i = 0; $i < max(count($application['liabilities']['main']['overdraft'] ?? 0), count($application['liabilities']['joint']['overdraft'] ?? 0)); $i++)
                            @if (isset($application['liabilities']['main']['overdraft'][$i]) &&
                                    $application['liabilities']['main']['overdraft'][$i]['provider'] != 'ANZ')
                                <div class="box__flex mb__2">
                                    <div class="box__20">
                                    ...
                                    <div class="box__54">
                                        <div class="pr__2">
                                            <input class="anz-form__input-dashed" type="text" name=""
                                                value="{{ $application['liabilities']['main']['overdraft'][$i]['provider'] }}">
                                        </div>
                                    </div>
                                    <div class="box__13 pr__2">
                                        <div class="box__flex">
                                            ...
                                            <div class="flex__1">
                                                <input class="anz-form__input-dashed" type="text" name=""
                                                    value="{{ $application['liabilities']['main']['overdraft'][$i]['limit'] ?? '0' }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="box__13 pr__2">
                                        <div class="box__flex">
                                            ...
                                            <div class="flex__1">
                                                <input class="anz-form__input-dashed" type="text" name=""
                                                    value="{{ $application['liabilities']['main']['overdraft'][$i]['balance'] ?? '0' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @if (isset($application['liabilities']['joint']['overdraft'][$i]) &&
                                    $application['liabilities']['joint']['overdraft'][$i]['provider'] != 'ANZ')
                                <div class="box__flex mb__2">
                                    <div class="box__20">
                                        <p>Non-ANZ overdraft</p>
                                    </div>
                                    <div class="box__54">
                                        <div class="pr__2">
                                            <input class="anz-form__input-dashed" type="text" name=""
                                                value="{{ $application['liabilities']['joint']['overdraft'][$i]['provider'] }}">
                                        </div>
                                    </div>
                                    <div class="box__13 pr__2">
                                        <div class="box__flex">
                                            ...
                                            <div class="flex__1">
                                                <input class="anz-form__input-dashed" type="text" name=""
                                                    value="{{ $application['liabilities']['joint']['overdraft'][$i]['limit'] ?? '0' }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="box__13 pr__2">
                                        <div class="box__flex">
                                            ...
                                            <div class="flex__1">
                                                <input class="anz-form__input-dashed" type="text" name=""
                                                    value="{{ $application['liabilities']['joint']['overdraft'][$i]['balance'] ?? '0' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @for ($i = 0; $i < max(count($application['liabilities']['main']['credit_card'] ?? 0), count($application['liabilities']['joint']['credit_card'] ?? 0)); $i++)
                            @if (isset($application['liabilities']['main']['credit_card'][$i]) &&
                                    $application['liabilities']['main']['credit_card'][$i]['provider'] != 'ANZ')
                                <div class="box__flex mb__2">
                                    <div class="box__20">
                                    ...
                                    <div class="box__54">
                                        <div class="pr__2">
                                            <input class="anz-form__input-dashed" type="text" name=""
                                                value="{{ $application['liabilities']['main']['credit_card'][$i]['provider'] }}">
                                        </div>
                                    </div>
                                    <div class="box__13 pr__2">
                                        <div class="box__flex">
                                            ...
                                            <div class="flex__1">
                                                <input class="anz-form__input-dashed" type="text" name=""
                                                    value="{{ $application['liabilities']['main']['credit_card'][$i]['limit'] ?? '0' }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="box__13 pr__2">
                                        <div class="box__flex">
                                            ...
                                            <div class="flex__1">
                                                <input class="anz-form__input-dashed" type="text" name=""
                                                    value="{{ $application['liabilities']['main']['credit_card'][$i]['balance'] ?? '0' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @if (isset($application['liabilities']['joint']['credit_card'][$i]) &&
                                    $application['liabilities']['joint']['credit_card'][$i]['provider'] != 'ANZ')
                                <div class="box__flex mb__2">
                                    <div class="box__20">
                                        <p>Non-ANZ credit card</p>
                                    </div>
                        ...
                        @foreach ($liabilities['main'] as $liabilityType => $items)
                            @foreach ($items as $liability)
                                <!-- col 1 -->
                                <div class="box__flex mb__2">
                                    <div class="flex-none w-[21%]">
                                        <div class="pr__2">
                                            <input class="anz-form__input-dashed" type="text" name=""
                                                value="{{ isset($liability['provider']) ? $liability['provider'] : 'N/A' }}">
                                        </div>
                                    </div>
                                    <div class="flex-none w-[21%]">
                                        <div class="pr__2">
                                            <input class="anz-form__input-dashed" type="text" name=""
                                                value="{{ isset($liability['liability_type']) ? $liability['liability_type'] : 'N/A' }}">
                                        </div>
                                    </div>
                                    <div class="flex-none w-[13%] pr__2">
                                        <div class="box__flex">
                                            ...
                                            <div class="flex__1">
                                                <input class="anz-form__input-dashed" type="text" name=""
                                                    value="{{ isset($liability['balance']) ? $liability['balance'] : 'N/A' }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex-none w-[7%] pr__2">
                                    ...
                                    <div class="flex-none w-[11%] pr__2">
                                        <div class="box__flex">
                                            ...
                                            <div class="flex__1">
                                                <input class="anz-form__input-dashed" type="text" name=""
                                                    value="{{ isset($liability['minimum_monthly_repayment']) ? $liability['minimum_monthly_repayment'] : 'N/A' }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div lass="flex__1 pr__2">
                                        <div class="box-item-end">
                                            ...
                                            <div class="anz-input__col-box">
                                                <input class="anz-form__input anz-input__col-4" type="text"
                                                    name="">
                                                <div>
                                                    <span class="anz-input-box anz-input-box-1"></span>
                                                    <span class="anz-input-box anz-input-box-2"></span>
                        ...
                        <div class="box__flex pt__6 pr__2 mb__2">
                            ...
                            <div class="flex-none w-[35%] pr__3">
                                <div class="box__flex">
                                    ...
                                    <div class="flex__1">
                                        <input class="anz-form__input-dashed" type="text" name=""
                                            value="{{ $liabilities['main']['other'][0]['description'] }}"
                                            value="{{ $liabilities['main']['other'][0]['balance'] }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box__flex pr__2 mb__2">
                                ...
                                <div class="flex-none w-[35%] pr__3">
                                    <div class="box__flex mb__2">
                                        ...
                                        <div class="flex__1">
                                            <input class="anz-form__input-dashed" type="text" name=""
                                                value="{{ isset($application['incomes']['main']['salary_incomes'][$i]) ? $application['incomes']['main']['salary_incomes'][$i]['base_salary'] : 0 }}">
                                        </div>
                                    </div>
                                    <div class="anz-input__checkbox-flex">
                                        <div class="anz-input__checkbox-group">
                                            <label class="anz-input__checkbox-label">Weekly
                                                <input class="anz-input__checkbox-input" type="checkbox"
                                                    {{ isset($application['incomes']['main']['salary_incomes'][$i]) && $application['incomes']['main']['salary_incomes'][$i]['base_salary_duration_type'] == 'weekly' ? 'checked' : '' }}>
                                                <span class="anz-input__checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="anz-input__checkbox-group">
                                            <label class="anz-input__checkbox-label">Fortnightly
                                                <input class="anz-input__checkbox-input" type="checkbox"
                                                    {{ isset($application['incomes']['main']['salary_incomes'][$i]) && $application['incomes']['main']['salary_incomes'][$i]['base_salary_duration_type'] == 'fortnightly' ? 'checked' : '' }}>
                                                <span class="anz-input__checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="anz-input__checkbox-group">
                                            <label class="anz-input__checkbox-label">Monthly
                                                <input class="anz-input__checkbox-input" type="checkbox"
                                                    {{ isset($application['incomes']['main']['salary_incomes'][$i]) && $application['incomes']['main']['salary_incomes'][$i]['base_salary_duration_type'] == 'monthly' ? 'checked' : '' }}>
                                                <span class="anz-input__checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="anz-input__checkbox-group">
                                            <label class="anz-input__checkbox-label">Yearly
                                                <input class="anz-input__checkbox-input" type="checkbox"
                                                    {{ isset($application['incomes']['main']['salary_incomes'][$i]) && $application['incomes']['main']['salary_incomes'][$i]['base_salary_duration_type'] == 'yearly' ? 'checked' : '' }}>
                                                <span class="anz-input__checkmark"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="flex-none w-[35%] pl__3">
                                    <div class="box__flex mb__2">
                                        ...
                                        <div class="flex__1">
                                            <input class="anz-form__input-dashed" type="text" name=""
                                                value="{{ isset($application['incomes']['joint']['salary_incomes'][$i]) ? $application['incomes']['joint']['salary_incomes'][$i]['base_salary'] : 0 }}">
                                        </div>
                                    </div>
                                    <div class="anz-input__checkbox-flex">
                                        <div class="anz-input__checkbox-group">
                                            <label class="anz-input__checkbox-label">Weekly
                                                <input class="anz-input__checkbox-input" type="checkbox"
                                                    {{ isset($application['incomes']['joint']['salary_incomes'][$i]) && $application['incomes']['joint']['salary_incomes'][$i]['base_salary_duration_type'] == 'weekly' ? 'checked' : '' }}>
                                                <span class="anz-input__checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="anz-input__checkbox-group">
                                            <label class="anz-input__checkbox-label">Fortnightly
                                                <input class="anz-input__checkbox-input" type="checkbox"
                                                    {{ isset($application['incomes']['joint']['salary_incomes'][$i]) && $application['incomes']['joint']['salary_incomes'][$i]['base_salary_duration_type'] == 'fortnightly' ? 'checked' : '' }}>
                                                <span class="anz-input__checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="anz-input__checkbox-group">
                                            <label class="anz-input__checkbox-label">Monthly
                                                <input class="anz-input__checkbox-input" type="checkbox"
                                                    {{ isset($application['incomes']['joint']['salary_incomes'][$i]) && $application['incomes']['joint']['salary_incomes'][$i]['base_salary_duration_type'] == 'monthly' ? 'checked' : '' }}>
                                                <span class="anz-input__checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="anz-input__checkbox-group">
                                            <label class="anz-input__checkbox-label">Yearly
                                                <input class="anz-input__checkbox-input" type="checkbox"
                                                    {{ isset($application['incomes']['joint']['salary_incomes'][$i]) && $application['incomes']['joint']['salary_incomes'][$i]['base_salary_duration_type'] == 'yearly' ? 'checked' : '' }}>
                                                <span class="anz-input__checkmark"></span>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="box__flex pr__2 mb__2">
                                ...
                                <div class="flex-none w-[35%] pr__3">
                                    <div class="anz-input__checkbox-group box-inline">
                                        <label class="anz-input__checkbox-label">Yes
                                            <input class="anz-input__checkbox-input" type="checkbox"
                                                {{ count($application['assets']['main']['kiwisavers']) > 0 ? 'checked' : '' }}>
                                            <span class="anz-input__checkmark"></span>
                                        </label>
                                    </div>
                                ...
                                <div class="flex-none w-[35%] pl__3">
                                    <div class="anz-input__checkbox-group box-inline">
                                        <label class="anz-input__checkbox-label">Yes
                                            <input class="anz-input__checkbox-input" type="checkbox"
                                                {{ count($application['assets']['joint']['kiwisavers']) > 0 ? 'checked' : '' }}>
                                            <span class="anz-input__checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="box__inline-flex pr__2">
                        ...
                        <div class="box__flex pr__2 mb__2">
                            ...
                            <div class="flex-none w-[35%] pr__3">
                                <div class="anz-input__checkbox-group box-inline">
                                    <label class="anz-input__checkbox-label">Yes
                                        <input class="anz-input__checkbox-input" type="checkbox"
                                            {{ count($application['liabilities']['main']['student_loan']) > 0 ? 'checked' : '' }}>
                                        <span class="anz-input__checkmark"></span>
                                    </label>
                                </div>
                                <div class="anz-input__checkbox-group box-inline">
                            ...
                            <div class="flex-none w-[35%] pl__3">
                                <div class="anz-input__checkbox-group box-inline">
                                    <label class="anz-input__checkbox-label">Yes
                                        <input class="anz-input__checkbox-input" type="checkbox"
                                            {{ count($application['liabilities']['joint']['student_loan']) > 0 ? 'checked' : '' }}>
                                        <span class="anz-input__checkmark"></span>
                                    </label>
                                </div>
                                <div class="anz-input__checkbox-group box-inline">
                        ...
                        <div class="box__flex pr__2 mb__1">
                            ...
                            <div class="flex-none w-[35%] pr__3">
                                <div class="box__flex mb__1">
                                    ...
                                    <div class="flex__1">
                                        <input class="anz-form__input-dashed" type="text" name=""
                                            value="{{ array_sum(array_map(function ($student_loan) {return $student_loan['balance'];}, $application['liabilities']['main']['student_loan'])) }}">
                                    </div>
                                </div>
                            </div>
                            <div class="flex-none w-[35%] pl__3">
                                <div class="box__flex mb__1">
                                    ...
                                    <div class="flex__1">
                                        <input class="anz-form__input-dashed" type="text" name=""
                                            value="{{ array_sum(array_map(function ($student_loan) {return $student_loan['balance'];}, $application['liabilities']['joint']['student_loan'])) }}">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="page-anz__content">
                <form action="/action_page.php">
                    <div class="page-anz__form mr__6">
                        ...
                        @foreach ($download_sop['expenses'] as $item)
                            <div class="box__flex mb__1">
                                <div class="flex-none w-[65%]">
                                    <p>{{ $item['label'] }}</p>
                                </div>
                                <div class="flex-none w-[35%] pr__3">
                                    ...
                                    <div class="anz-input__checkbox-flex">
                                        ...
                                        <div class="anz-input__checkbox-group">
                                            <label class="anz-input__checkbox-label">Monthly
                                                <input class="anz-input__checkbox-input" type="checkbox"
                                                    {{ $item['frequency'] == 'monthly' ? 'checked' : '' }}>
                                                <span class="anz-input__checkmark"></span>
                                            </label>
                                        </div>
                                    </div>
                        ...
                        @foreach ($expenses as $item => $value)
                            @foreach ($value as $expense)
                                ...
                                <div class="box__flex mb__1">
                                    ...
                                    <div class="flex-none w-[65%]">
                                        <p>{{ isset($expense['expense_type']) ? $expense['expense_type'] : $expense['liability_type'] }}
                                        </p>
                                    </div>
                                    <div class="flex-none w-[35%] pr__3">
                                        <div class="box__flex mb__2">
                                            <label>$</label>
                                            <div class="flex__1">
                                                <input class="anz-form__input-dashed"
                                                    value="{{ $expense['amount'] }}" type="text"
                                                    name="">
                                            </div>
                                        </div>
                                        <div class="anz-input__checkbox-flex">
                                            <div class="anz-input__checkbox-group">
                                                <label class="anz-input__checkbox-label">Weekly
                                                    <input class="anz-input__checkbox-input" type="checkbox"
                                                        {{ $item['amount_duration_type'] == 'weekly' ? 'checked' : '' }}>
                                                    <span class="anz-input__checkmark"></span>
                                                </label>
                                            </div>
                                            <div class="anz-input__checkbox-group">
                                                <label class="anz-input__checkbox-label">Fortnightly
                                                    <input class="anz-input__checkbox-input" type="checkbox"
                                                        {{ $item['amount_duration_type'] == 'yearly' ? 'checked' : '' }}>
                                                    <span class="anz-input__checkmark"></span>
                                                </label>
                                            </div>
                                            <div class="anz-input__checkbox-group">
                                                <label class="anz-input__checkbox-label">Monthly
                                                    <input class="anz-input__checkbox-input" type="checkbox"
                                                        {{ $item['amount_duration_type'] == 'monthly' ? 'checked' : '' }}>
                                                    <span class="anz-input__checkmark"></span>
                                                </label>
                                            </div>
                                        </div>
                        ...
                        @foreach ($expenses['main']['other'] as $item => $value)
                            <div class="box__flex mb__1">
                                <div class="flex-none w-[65%]">
                                ...
                                <div class="flex-none w-[35%] pr__3">
                                    ...
                                    <div class="anz-input__checkbox-flex">
                                        <div class="anz-input__checkbox-group">
                                            <label class="anz-input__checkbox-label">Weekly
                                                <input class="anz-input__checkbox-input" type="checkbox"
                                                    {{ $value['amount_duration_type'] == 'weekly' ? 'checked' : '' }}>
                                                <span class="anz-input__checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="anz-input__checkbox-group">
                                            <label class="anz-input__checkbox-label">Fortnightly
                                                <input class="anz-input__checkbox-input" type="checkbox"
                                                    {{ $value['amount_duration_type'] == 'yearly' ? 'checked' : '' }}>
                                                <span class="anz-input__checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="anz-input__checkbox-group">
                                            <label class="anz-input__checkbox-label">Monthly
                                                <input class="anz-input__checkbox-input" type="checkbox"
                                                    {{ $value['amount_duration_type'] == 'monthly' ? 'checked' : '' }}>
                                                <span class="anz-input__checkmark"></span>
                                            </label>
                                        </div>
                                    </div>
                    ...
                    <div class="page-anz__form mr__6">
                        ...
                        <div class="box__flex pt__4 pr__2">
                            ...
                            <div class="flex-none w-[68%] pr__3">
                                <div class="mb__2">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $incomes['main']['business_incomes'][0]['business_registered_name'] }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box__flex pr__2">
                            ...
                            <div class="flex-none w-[68%] pr__3">
                                <div class="mb__2">
                                    <input class="anz-form__input-dashed" type="text" name=""
                                        value="{{ $incomes['main']['business_incomes'][0]['ird_number'] }}">
                                </div>
                            </div>
                        </div>
            ...
            <div class="page-anz__content">
                <form action="/action_page.php">
                    <div class="page-anz__form mr__6">
                        ...
                        <p><strong>Please provide details of any non-ANZ lending facilities</strong> (e.g. other bank
                            overdrafts,
                            hire
                        ...
                        @foreach ($download_sop['other_loans'] as $loanType => $loanDetail)

                            <div class="box__flex mb__2">
                                <div class="flex-none w-[21%]"> 
                                    <div class="pr__2">
                                        <input class="anz-form__input-dashed" type="text" name=""
                                            value="{{ $loanDetail['provider'] }}">
                                    </div>
                                </div>
                                <div class="flex-none w-[21%]">
                                    <div class="pr__2">
                                        <input class="anz-form__input-dashed" type="text" name=""  value="{{ $loanDetail['label'] }}">
                                    </div>
                                </div>
                                <div class="flex-none w-[13%] pr__2">
                                    <div class="box__flex">
                                        <label>$</label>
                                        <div class="flex__1">
                                            <input class="anz-form__input-dashed" type="text" name=""  value="{{ $loanDetail['balance'] }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="flex-none w-[7%] pr__2">
                                    <div class="box__flex">
                                        <div class="flex__1">
                                            <input class="anz-form__input-dashed" type="text" name=""  value="{{ $loanDetail['repayment'] }}">
                                        </div>
                                        <p>%</p>
                                    </div>
                                </div>
                        ...
                        <div class="pt__2 mb__2">
                            <p><strong>Please attach your current summary from Xero, MYOB, etc.</strong> Otherwise fill
                                in the section
                                below.</p>
                        </div>
                        ...
                        <div class="pt__4">
                            ...
                            <p>I/we certify that all information supplied in this form is true, correct and complete in
                                every respect
                                and I/we have the authority to
                                provide this information.</p>
                            <p>I/we understand that, and consent to, ANZ collecting, using and disclosing the personal
                                information
                                that
                                I/we provide as part of
                                this form in accordance with ANZ’s Privacy Statement available at www.anz.co.nz/privacy.
                            </p>
                            <p>I/we confirm that I/we are happy for ANZ to get a credit report about me/us. I/we
                                understand this will
                                involve the disclosure of
                                personal information to credit reporting agencies who may also disclose that information
                                to their
                                customers.</p>
                        </div>
                    ...
                    <div class="page-anz__form mr__6">
                        ...
                        <div class="anz-input__checkbox-group pt__2 mb__2">
                            <label class="anz-input__checkbox-label">
                                <span>Confirmation of income (e.g. wage slip, letter from employer, rental
                                    income).</span>
                                <input class="anz-input__checkbox-input" type="checkbox">
                                <span class="anz-input__checkmark"></span>
                            </label>
                        ...
                        <div class="anz-input__checkbox-group mb__2">
                            <label class="anz-input__checkbox-label">
                                <span>90 days of bank statements for each non-ANZ bank account in PDF format (not a
                                    transaction
                                    summary).</span>
                                <input class="anz-input__checkbox-input" type="checkbox">
                                <span class="anz-input__checkmark"></span>
                        ...
                        <div class="anz-input__checkbox-group mb__2">
                            <label class="anz-input__checkbox-label">
                                <span>Valid proof of identification. Examples of acceptable forms of identification can
                                    be found at
                        ...
                        <div class="anz-input__checkbox-group mb__2">
                            <label class="anz-input__checkbox-label">
                                <span>A piece of mail addressed to your residential address from the last three months.
                                    Examples of
                        ...
                        <div class="anz-input__checkbox-group mb__2">
                            <label class="anz-input__checkbox-label">
                                <span>If selling and purchasing, signed sale and purchase agreement of property being
                                    sold.</span>
                                <input class="anz-input__checkbox-input" type="checkbox">
                                <span class="anz-input__checkmark"></span>
                            </label>
                        ...
                        <div class="anz-input__checkbox-group mb__2">
                            <label class="anz-input__checkbox-label">
                                <span>For a Family Trust/LTC (Look Through Company) a copy of the Trust Deed/Company
                                    Certificate of
                                    Incorporation.</span>
                                <input class="anz-input__checkbox-input" type="checkbox">
                                <span class="anz-input__checkmark"></span>
                        ...
                        <div class="anz-input__checkbox-group mb__2">
                            <label class="anz-input__checkbox-label">
                                <span>If building, a copy of the Building Contract/Fixed Price Contract and the Building
                                    Consent.</span>
                                <input class="anz-input__checkbox-input" type="checkbox">
                                <span class="anz-input__checkmark"></span>
                            </label>
